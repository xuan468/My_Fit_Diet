    ...
    <div class="navbar-container">
        <nav class="navbar">
            ...
            <div class="nav-links">    
                <!-- Challenges Dropdown -->
                <div class="dropdown">
                <a href="#" id="reviewBtn" class="<?php echo in_array(basename($_SERVER['PHP_SELF']), ['reviewchallengecomment.php', 'reviewcommunity.php', 'reviewfeedback.php', 'reviewuser.php']) ? 'active' : ''; ?>">Review</a>
                <div class="dropdown-menu" id="reviewDropdown">
                        ...
                        <a href="/MyFitDiet/profile/reviewer/reviewuser.php">User</a>
                    </div>
                </div>
            </div>
